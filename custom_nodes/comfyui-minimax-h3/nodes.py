...
from .upscale_nodes import (NODE_CLASS_MAPPINGS as _UP, NODE_DISPLAY_NAME_MAPPINGS as _UPN)  # noqa: E402
NODE_CLASS_MAPPINGS.update(_UP)
NODE_DISPLAY_NAME_MAPPINGS.update(_UPN)
