...
- 画幅：**9:16 竖屏**；风格锁定：**电影级写实光影**——人物正面被暖色台灯主光照亮、显示器和显微镜台灯给冷色补光，有方向、有层次的阴影和适度对比，干净锐利，浅景深，真实且有纵深的实验室。**禁止**整片平铺蓝光（网剧棚拍感），也不要"手持 / 纪录片 / 颗粒 / 无调色"（会把脸藏进暗处）。location_en 要写出具体光源
